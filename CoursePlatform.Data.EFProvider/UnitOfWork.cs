...
namespace CoursePlatform.Data.EFProvider
{
        ...
        where TContext : DbContext, IDisposable
    {
        ...
        public IRepositoryAsync<TEntity> GetRepositoryAsync<TEntity>() where TEntity :EntityBase, new()
        {
            if (_repositories == null) _repositories = new Dictionary<Type, object>();
        ...
        public IRepositoryReadOnly<TEntity> GetReadOnlyRepository<TEntity>() where TEntity : EntityBase,new()
        {
            if (_repositories == null) _repositories = new Dictionary<Type, object>();
